...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Shared_Alert_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Shared/Alert.vue */ "./resources/js/components/Shared/Alert.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Transactions",
  components: {
    Alert: _Shared_Alert_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm._v("Cancel")]) : _vm._e()], 1), _vm._v(" "), _c("b-alert", {
    attrs: {
      show: _vm.dismissCountDown,
      dismissible: "",
      variant: "success"
    ...
    scopedSlots: _vm._u([{
      ...
      key: "cell(edit)",
      fn: function fn(data) {
        return [_vm.transactions[data.index].isEdit ? _c("b-button", {
          on: {
...
/* harmony import */ var _Alert_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Alert.vue?vue&type=script&lang=js& */ "./resources/js/components/Shared/Alert.vue?vue&type=script&lang=js&");
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Shared/Alert.vue"
